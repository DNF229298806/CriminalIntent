...
public class DatePickerFragment extends DialogFragment {
    ...
    public static final String EXTRA_DATE = "example.com.criminalintent.date";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dataPicker = v.findViewById(R.id.dp_dialog_date_picker);
        dataPicker.init(year, month, day, null);
